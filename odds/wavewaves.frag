// Fork of "Synth waves" by avin. https://shadertoy.com/view/Wts3DB
// 2019-07-02 13:22:43
...
float simplex_noise(vec3 p)
{
    ...
    vec4 n = (sin(iTime)+2.)*0.5 * h * h * h * h * vec4(dot(d0, hash33(i)), dot(d1, hash33(i + i1)), dot(d2, hash33(i + i2)), dot(d3, hash33(i + 1.0)));
    
    return dot(vec4(50.316), n);
}
