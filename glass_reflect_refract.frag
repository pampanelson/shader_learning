// Fork of "Cornell Box variant" by jimmikaelkael. https://shadertoy.com/view/XlB3RR
// 2019-05-09 06:50:06
...
{
    vec2 p = (-iResolution.xy + 2.0 * fragCoord.xy) / iResolution.y; // y : -1. to 1. 

    vec3 eye = vec3(278.0, 273.0, 1800.0);
